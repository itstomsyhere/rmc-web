            ...
            {g.items.map(it => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'flex items-center gap-2.5 border-l-[3px] px-3 py-2 text-left text-[13px] transition-colors duration-fast',
            ...
            {g.items.map(it => {
              ...
              return (
                <button
                  ...
                  className={cn('flex h-9 shrink-0 items-center gap-1.5 whitespace-nowrap rounded-full border px-3 text-[13px] transition-colors', on ? 'border-teal-500 bg-teal-500 font-bold text-white' : 'border-line bg-white font-medium text-ink-2 hover:border-ink-4')}
                >
