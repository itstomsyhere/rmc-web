...
;(async () => {
  ...
  ok((await p.locator('#benefit [data-steps] ol > li').count()) === 4 && /Diskon\s*Belanja/.test(t) && /Dapatkan\s*Point/.test(t) && /Tukarkan\s*Voucher/.test(t) && /Nikmati\s*Keuntungannya/.test(t), 'four-step strip: Diskon Belanja → Dapatkan Point → Tukarkan Voucher → Nikmati Keuntungannya')
